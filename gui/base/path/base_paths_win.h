...
#ifndef GUI_BASE_PATH_BASE_PATHS_WIN_H_
#define GUI_BASE_PATH_BASE_PATHS_WIN_H_
...
enum {
  ...
  DIR_APP_DATA_HBGUI,    // DIR_APP_DATA\hbdemo
...
#endif  // GUI_BASE_PATH_BASE_PATHS_WIN_H_
