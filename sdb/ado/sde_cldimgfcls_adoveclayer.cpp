...
namespace _SDEAdo {
CldImgFclsDBLayer::CldImgFclsDBLayer(DataSource *pOwnerDs)
    : AdoVecLayer(pOwnerDs) {}

CldImgFclsDBLayer::~CldImgFclsDBLayer(void) {}

//////////////////////////////////////////////////////////////////////////
bool CldImgFclsDBLayer::Create(void) {
  bool bRet = true;
  ...
  info.unFeatureType = FtChildImage;
...
//////////////////////////////////////////////////////////////////////////
void CldImgFclsDBLayer::SetDefaultAttFields(void) {
...
void CldImgFclsDBLayer::SetDefaultGeomFields(void) {
...
void CldImgFclsDBLayer::SetTableFields(void) {
...
//////////////////////////////////////////////////////////////////////////
void CldImgFclsDBLayer::GetFeature(Feature *pFeature) {
  if (!pFeature) return;
  ...
  GetGeom(pGeom);
  //////////////////////////////////////////////////////////////////////////
  m_Recordset.GetCollect("childimage_id", nCldImg);
  //////////////////////////////////////////////////////////////////////////
  pFeature->SetID(nID);
  pFeature->SetFeatureType(FeatureType::FtChildImage);
  pFeature->SetStyleDirectly(pStyle);
  pFeature->SetGeometryDirectly(pGeom);
  pFeature->SetFieldValue(pFeature->GetFieldIndexByName("childimage_id"),
                          nCldImg);
}

//////////////////////////////////////////////////////////////////////////
long CldImgFclsDBLayer::AppendFeature(const Feature *pFeature, bool bclone) {
  ...
  m_Recordset.PutCollect("childimage_id", _variant_t(nCldImg));
...
long CldImgFclsDBLayer::AppendFeatureBatch(const Feature *pFeature,
                                           bool bclone) {
  long lRet = SMT_ERR_NONE;
  //////////////////////////////////////////////////////////////////////////
  // db
...
long CldImgFclsDBLayer::UpdateFeature(const Feature *pFeature) {
  //////////////////////////////////////////////////////////////////////////
  // db
...
long CldImgFclsDBLayer::AppendStyle(const Style *pStyle) {
...
long CldImgFclsDBLayer::GetStyle(Style *&pStyle) {
  pStyle = new Style();
...
//////////////////////////////////////////////////////////////////////////
long CldImgFclsDBLayer::AppendGeom(const Geometry *pGeom) {
  long lRet = SMT_ERR_NONE;
...
long CldImgFclsDBLayer::GetGeom(Geometry *&pGeom) {
  long lRet = SMT_ERR_NONE;
  int nGeomType = 0;
...
long CldImgFclsDBLayer::AppendPoint(const Point *pPoint) {
  int nPoints = 1;
...
long CldImgFclsDBLayer::GetPoint(Geometry *&pGeom) {
  int nPoints = 0;
