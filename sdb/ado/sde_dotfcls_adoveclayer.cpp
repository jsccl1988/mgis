...
namespace _SDEAdo {
DotFclsAdoLayer::DotFclsAdoLayer(DataSource *pOwnerDs) : AdoVecLayer(pOwnerDs) {
  ;
}

DotFclsAdoLayer::~DotFclsAdoLayer(void) {}

//////////////////////////////////////////////////////////////////////////
bool DotFclsAdoLayer::Create(void) {
  bool bRet = true;
...
//////////////////////////////////////////////////////////////////////////
void DotFclsAdoLayer::SetDefaultAttFields(void) {
...
void DotFclsAdoLayer::SetDefaultGeomFields(void) {
...
void DotFclsAdoLayer::SetTableFields(void) {
...
//////////////////////////////////////////////////////////////////////////
void DotFclsAdoLayer::GetFeature(Feature *pFeature) {
  if (!pFeature) return;
...
//////////////////////////////////////////////////////////////////////////
long DotFclsAdoLayer::AppendFeature(const Feature *pFeature, bool bclone) {
...
long DotFclsAdoLayer::AppendFeatureBatch(const Feature *pFeature, bool bclone) {
  long lRet = SMT_ERR_NONE;
  //////////////////////////////////////////////////////////////////////////
  // db
  if (!IsOpen())
...
long DotFclsAdoLayer::UpdateFeature(const Feature *pFeature) {
  //////////////////////////////////////////////////////////////////////////
  // db
...
long DotFclsAdoLayer::AppendStyle(const Style *pStyle) {
...
long DotFclsAdoLayer::GetStyle(Style *&pStyle) {
  pStyle = new Style();
...
//////////////////////////////////////////////////////////////////////////
long DotFclsAdoLayer::AppendGeom(const Geometry *pGeom) {
  long lRet = SMT_ERR_NONE;
  ...
  switch (type) {
    case GTPoint:
      ...
      break;
    case GTMultiPoint:
      lRet = AppendPoints((MultiPoint *)pGeom);
    default:
      break;
  }
...
long DotFclsAdoLayer::GetGeom(Geometry *&pGeom) {
  long lRet = SMT_ERR_NONE;
  int nGeomType = 0;
...
long DotFclsAdoLayer::AppendPoint(const Point *pPoint) {
  int nPoints = 1;
...
long DotFclsAdoLayer::AppendPoints(const MultiPoint *pPoints) {
  ...
  for (int i = 0; i < nPoints; i++) {
    const Point *pPoint = (Point *)pPoints->GetGeometryRef(i);
    pRawPoints[i].x = pPoint->GetX();
    pRawPoints[i].y = pPoint->GetY();
  }

  //////////////////////////////////////////////////////////////////////////
  m_Recordset.PutCollect("geom_type", _variant_t(GTMultiPoint));
  m_Recordset.PutCollect("geom_pointnum", _variant_t(nPoints));
...
long DotFclsAdoLayer::GetPoint(Geometry *&pGeom) {
  int nPoints = 0;
...
long DotFclsAdoLayer::GetPoints(Geometry *&pGeom) {
  int nPoints = 0;
  m_Recordset.GetCollect("geom_pointnum", nPoints);
