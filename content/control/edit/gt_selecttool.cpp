...
int SelectTool::Init(LPRENDERDEVICE pMrdRenderDevice, Map *pOperMap, HWND hWnd,
  ...
  AppendFunctionItems("点选", GT_MSG_SELECT_POINTSEL, FIM_2DVIEW | FIM_2DMFMENU);
  AppendFunctionItems("框选", GT_MSG_SELECT_RECTSEL, FIM_2DVIEW | FIM_2DMFMENU);
  AppendFunctionItems("多边形选取", GT_MSG_SELECT_POLYGONSEL,
                  FIM_2DVIEW | FIM_2DMFMENU);
  AppendFunctionItems("清除选择要素", GT_MSG_SELECT_CLEAR,
                  FIM_2DVIEW | FIM_2DMFMENU);
