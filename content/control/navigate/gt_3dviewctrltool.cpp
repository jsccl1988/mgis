...
int 3DViewCtrlTool ::Init(LP3DRENDERDEVICE p3DRenderDevice, Scene* pScene,
  ...
  AppendFunctionItems("追踪球", GT_MSG_3DVIEW_TRACEBALL, FIM_3DVIEW | FIM_3DMFMENU);
  AppendFunctionItems("球面相机", GT_MSG_3DVIEW_SPHERECAMERA,
                  FIM_3DVIEW | FIM_3DMFMENU);
  AppendFunctionItems("第一视角", GT_MSG_3DVIEW_FIRSTPERSON,
                  FIM_3DVIEW | FIM_3DMFMENU);
  AppendFunctionItems("复位", GT_MSG_3DVIEW_RESTORE, FIM_3DVIEW | FIM_3DMFMENU);
  // AppendFunctionItems("二维视图",GT_MSG_VIEW_ACTIVE,FIM_3DVIEW);
