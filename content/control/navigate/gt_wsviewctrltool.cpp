...
int WSViewCtrlTool::Init(LPRENDERDEVICE pMrdRenderDevice, Map *pOperMap,
  ...
  AppendFunctionItems("放大", GT_MSG_WSVIEW_ZOOMIN, FIM_2DVIEW | FIM_2DMFMENU);
  AppendFunctionItems("缩小", GT_MSG_WSVIEW_ZOOMOUT, FIM_2DVIEW | FIM_2DMFMENU);
  AppendFunctionItems("移动", GT_MSG_WSVIEW_ZOOMMOVE, FIM_2DVIEW | FIM_2DMFMENU);
  AppendFunctionItems("复位", GT_MSG_WSVIEW_ZOOMRESTORE, FIM_2DVIEW | FIM_2DMFMENU);
  AppendFunctionItems("刷新", GT_MSG_WSVIEW_ZOOMREFRESH, FIM_2DVIEW | FIM_2DMFMENU);
