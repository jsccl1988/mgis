...
class EXPORT_CLASS SmtMap {
 ...
 public:
  ...
  bool DeleteLayer(const char *name);
  ...
  void SetMapName(const char *name) {
    strcpy_s(m_szMapName, MAX_MAP_NAME, name);
  }
