...
enum PolygonMode { PM_POINT, PM_LINE, PM_FILL };

enum FogMode { FM_EXP, FM_EXP2, FM_LINEAR, FM_NONE };
...
enum FaceMode { FM_BACK = 0, FM_FRONT, FM_FRONT_AND_BACK };

enum AccessMode { READ_ONLY = 0, WRITE_ONLY, READ_WRITE };
}  // namespace _3Drd
