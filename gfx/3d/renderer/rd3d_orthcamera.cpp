...
namespace _3Drd {
OrthCamera::OrthCamera(LP3DRENDERDEVICE p3DRenderDevice, Viewport3D &viewport)
    : Camera(p3DRenderDevice, viewport), m_bIdentity(false), m_bInverse(false) {
  ;
}

OrthCamera::~OrthCamera(void) { m_p3DRenderDevice = NULL; }

long OrthCamera::Apply(void) {
  Camera::Apply();
