...
inline void Texture::SetPixel4f(float a, float r, float g, float b) {
...
inline void Texture::SetPixel3f(float r, float g, float b) {
...
inline void Texture::SetPixel4uc(unsigned char a, unsigned char r,
...
inline void Texture::SetPixel3uc(unsigned char r, unsigned char g,
                                 unsigned char b) {
  if (m_texDesc.format == RGB8) {
    m_pCurrentPixel[0] = r;
    m_pCurrentPixel[1] = g;
