...
namespace _3Drd {
ArbvCamera::ArbvCamera(LP3DRENDERDEVICE p3DRenderDevice, Viewport3D &viewport)
    : PerspCamera(p3DRenderDevice, viewport), m_fRaduis(0) {
  ;
}

ArbvCamera::~ArbvCamera(void) { ; }

void ArbvCamera::SetArbitMove(long deltX, long deltY) {
  // 从聚焦点指向视点的向量  OA向量
