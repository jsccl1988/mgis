...
// print implement
long GLText::CreateFont(HDC hDC, const char *chType, int nHeight, int nWidth,
  ...
  if (stricmp(chType, "symbol") == 0) {
    ...
    m_hFont =
        ::CreateFont(m_nHeight, m_nWidth, 0, 0, m_nWeight, bItalic, bUnderline,
                     bStrike, ANSI_CHARSET, OUT_TT_PRECIS, CLIP_DEFAULT_PRECIS,
