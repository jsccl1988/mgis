...
void DrawRect(HDC dc_, RECT &rect, BOOL is_xor = TRUE);
void DrawLine(HDC dc_, POINT *points, int size, BOOL is_xor = TRUE);
void DrawCross(HDC dc_, long x, long y, long r, BOOL is_xor = TRUE);
