...
//
// This file contains no "wstring" variants. New code should use std::wstring.
// If you need to make old code work, use the UTF8 version and convert. Please
// do not add wstring variants.
//
