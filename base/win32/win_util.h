...
BASE_EXPORT bool RunAppWithCommand(const wchar_t *application,
                                   const wchar_t *command,
                                   HANDLE *process = NULL);
BASE_EXPORT bool RunAppWithRedirection(const wchar_t *application,
                                       const wchar_t *command, HANDLE input,
...
BASE_EXPORT bool OpenResource(const wchar_t *resource, const wchar_t *type,
