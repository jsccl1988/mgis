...
bool Thread::Create() {
  // create thread first
  thread_handle_ = (HANDLE)_beginthreadex(NULL, 0, ThreadProcFunc, this, 0,
                                          (unsigned*)&thread_id_);
...
// static
void Thread::Sleep(int duration_ms) { ::Sleep(duration_ms); }

// static
void Thread::YieldThread() { ::Sleep(0); }

// static
ThreadId Thread::CurrentId() { return GetCurrentThreadId(); }
