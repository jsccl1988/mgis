...
class EncryptMethodInterface {
 public:
  ...
  virtual base::EncryptMethod Type() const = 0;
...
//
class EncryptInterface : public base::EncryptMethodInterface {
 public:
  virtual bool SetMethod(base::EncryptMethod type) = 0;
  virtual void ListSupportMethods(std::list<base::EncryptMethod> &types) = 0;
  virtual bool AddMethod(base::EncryptMethodInterface_var method) = 0;
  virtual bool RemoveMethod(base::EncryptMethod type) = 0;
  virtual base::EncryptMethodInterface *CreateMethod(
      base::EncryptMethod type) = 0;
};
...
inline base::EncryptMethod cm() {
  return base::ENC_NO;  // test
}
